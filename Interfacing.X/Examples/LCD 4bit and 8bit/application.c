...
int main() 
{
    ...
    ret = lcd_8bit_send_string_pos(&lcd1 , 1 , 1 , "Hello");
    ret = lcd_8bit_send_string_pos(&lcd1 , 2 , 2 , "World");
    
    ret = lcd_4bit_send_string_pos(&lcd2 , 1 , 1 , "Hi");
    ret = lcd_4bit_send_string_pos(&lcd2 , 2 , 2 , "All");
    while(1)
    {
